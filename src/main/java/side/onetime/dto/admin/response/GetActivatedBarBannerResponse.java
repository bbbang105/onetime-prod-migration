...
public record GetActivatedBarBannerResponse(
        Long id,
        String contentKor,
        String contentEng,
    ...
    public static GetActivatedBarBannerResponse from(BarBanner barBanner) {
        return new GetActivatedBarBannerResponse(
                barBanner.getId(),
